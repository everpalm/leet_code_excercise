...
partitions the list such that all nodes with values less than x come before
...
Details:
The function partition_list takes an integer x as a parameter and modifies the
...
#   +===================================================+
    def partition_list(self, x):
        less_head = less = Node(0)  # Dummy head for less list
        greater_head = greater = Node(0)  # Dummy head for greater list
    
        print('original greater = ', greater)
        print('original greater.next = ', greater.next)
        print('original greater_head = ', greater_head)
        print('original greater_head.next = ', greater_head.next)
        '''
        Q: Why do I need the variable less_head and greater_head?
        A: When I need to concatenate two link lists
        the lists have been iterated and the information I have is the 
        value and next pointer of last node.
        That's why I need to save the information of original less and
        greater before iteration - I can have the head information
        '''
        current = self.head
        while current:
            if current.value < x:
        ...
        print('greater.next = ', greater.next)
        print('greater_head = ', greater_head)
        print('greater_head.next = ', greater_head.next)
        ...
        '''
        Q: How to connect less to greater?
        A: Use the next pointer of Less to assign next node
        '''
