...
class Solution:
    def carFleet(self, target: int, position: List, speed: List) -> int:
        ...
        #     race_time = (target - position[i])/speed[i]
        #     print(f'race_time = {race_time}')
        #     print(f'car_fleet = {car_fleet}')
        #     if car_fleet and position[i] < position[car_fleet[-1]] and race_time in car_fleet:
        #         car_fleet.append(race_time)
        # return len(car_fleet)
        # Prepare a list of cars with their position, speed and time to target
        ...
        # Calculate number of fleets based on merging times
        for time in times:
...
# car_fleet(12, [10, 8, 0, 5, 3], [2, 4, 1, 1, 3])  # Expected output: 3
# car_fleet(10, [3], [3])  # Expected output: 1
# car_fleet(100, [0, 2, 4], [4, 2, 1])  # Expected output: 1

my_solution = Solution()
# target = 12
# position = [10,8,0,5,3]
# speed = [2,4,1,1,3]
# print('Result1 = ', my_solution.carFleet(target, position, speed))

# target = 10
# position = [3]
# speed = [3]
# print('Result2 = ', my_solution.carFleet(target, position, speed))

target = 100
position = [0,2,4]
speed = [4,2,1]
print('Result3 = ', my_solution.carFleet(target, position, speed))

# target = 24
# position = [4,8,12]
# speed = [5,4,3]
# print('Result4 = ', my_solution.carFleet(target, position, speed))

# target = 16
# position = [0,0,0]
# speed = [2,4,8]
# print('Result5 = ', my_solution.carFleet(target, position, speed))

# target = 16
# position = [0,4,8]
# speed = [4,4,4]
# print('Result6 = ', my_solution.carFleet(target, position, speed))

# target = 106
# position = [0,4,8]
# speed = [4,4,4]
# print('Result7 = ', my_solution.carFleet(target, position, speed))
